# Types — Consolidated TypeScript Types and Zod Schemas

Single source of truth for all types used across the application. Every module references these types. All runtime validation uses the Zod schemas. TypeScript interfaces are inferred from Zod where possible.
...
export const ParseResultSchema = z.object({
  success: z.boolean(),
  data: z.object({
    raw_data: z.array(z.record(z.unknown())),
